...
export class ParticleSystem {
  constructor(params) {
    ...
    console.log("Camera to assign to particles", params.camera);
    this._camera = params.camera;
    console.log("Camera  assigned to particles", this._camera);
    this._particles = [];
    ...
    console.log("Adding these points to scene", this._points, params.parent);
